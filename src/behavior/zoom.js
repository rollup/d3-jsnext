import { d3_eventPreventDefault, d3_eventDispatch } from '../event/event';
import { d3_selection_interrupt } from '../selection/interrupt';
...
export { d3$behavior$zoom, d3_behavior_zoomInfinity, d3_behavior_zoomDelta, d3_behavior_zoomWheel };